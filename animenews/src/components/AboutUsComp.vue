<template>
  <div>
    <div class="w-[1272px] h-[382px] flex">
      <img
      ...
      />
      <div class="w-[636px] h-[382px] relative bg-zinc-50">
        <img
        ...
        />
        <div class="absolute top-[25%] left-[10%] w-[471.14px]">
          <div>
            <h1 class="text-2xl font-raleway font-bold mb-2">About Us</h1>
            <p class="text-base text-pretty font-medium font-open-sans">
              ...
              walks of life. Our mission is to foster a community where anime and manga fans can
              come together to share their love for these art forms and discover new favorites.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="w-[1272px] h-[382px] flex">
      <div class="w-[636px] h-[382px] relative bg-zinc-50">
        ...
        <div class="absolute top-[25%] left-[10%] w-[471.14px]">
          <div>
            <h1 class="text-2xl font-raleway font-bold mb-2">What We Do</h1>
            <p class="text-base text-pretty font-medium font-open-sans">
              ...
              making "Gates" your go-to hub for anime and manga adventures. Join us in celebrating
              the vibrant world of anime and manga, where every story has the power to captivate and
              inspire.
            </p>
          </div>
        </div>
